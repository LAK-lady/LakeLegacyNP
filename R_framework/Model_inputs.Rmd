...
```{r}
Me_algae<- read.csv(file="Cleaned_data/Mendota_Algae.csv")
Me_extLoad<- read.csv(file="Cleaned_data/Mendota_P_allext.csv")
Me_intLoad<- read.csv(file="Cleaned_data/Mendota_P_allint.csv")
Me_hypoepiRatio<- read.csv(file="Cleaned_data/Mendota_P_water.csv")
```
...
```{r}
write.csv(Me_all_interp, file="Cleaned_data/Mendota_modeldata.csv")
```
