...
file_path= "Products/Figure16_color.png"
...
corrplot(M, #plot cor matrix
  ...
  #recordPlot() #call in the recordPlot function to record plot

fig16
ggsave(fig16, file="Products/Figure16_color.png")
```
...
SS_2013<- summary(YRregk_Chla_2013)#prints the sum of squares for the regression 
...
SS_2014<- summary(YRregk_Chla_2014)#prints the sum of squares for the regression 
...
SS_2015<- summary(YRregk_Chla_2015)#prints the sum of squares for the regression 
...
SS_2016<- summary(YRregk_Chla_2016)#prints the sum of squares for the regression 
...
SS_2017<- summary(YRregk_Chla_2017)#prints the sum of squares for the regression 
...
SS_2018<- summary(YRregk_Chla_2018)#prints the sum of squares for the regression 
impact2018<- data.frame(SS_2018[[1]])[,2,drop=FALSE] #pulls out the SS as table

Model_output_Chla<- cbind(impact2013, impact2014, impact2015, impact2016, 
                          impact2017, impact2018) #combines all tables together
colnames(Model_output_Chla)<- c("2013", "2014", "2015", "2016", "2017", "2018")
...
Model_output_CD<- cbind(impact2013, impact2014, impact2015, impact2016, 
                          impact2017, impact2018) #combines all tables together
colnames(Model_output_CD)<- c("2013", "2014", "2015", "2016", "2017", "2018")
# renames columns with year for sum squares
write.csv(Model_output_CD, file="Cleaned_data/Impact_model_output_Chla.csv")
```
