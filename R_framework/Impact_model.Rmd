...
```{r}
YRregk_Chla_2012<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2012)) #subset data by year
aov(YRregk_Chla_2012)#prints the sum of squares for the regression and residuals

YRregk_Chla_2013<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2013)) #subset data by year
aov(YRregk_Chla_2013)#prints the sum of squares for the regression and residuals

YRregk_Chla_2014<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2014)) #subset data by year
aov(YRregk_Chla_2014)#prints the sum of squares for the regression and residuals

YRregk_Chla_2015<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2015)) #subset data by year
aov(YRregk_Chla_2015)#prints the sum of squares for the regression and residuals

YRregk_Chla_2016<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2016)) #subset data by year
aov(YRregk_Chla_2016)#prints the sum of squares for the regression and residuals

YRregk_Chla_2017<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2017)) #subset data by year
aov(YRregk_Chla_2017)#prints the sum of squares for the regression and residuals

YRregk_Chla_2018<- glm(formula=log10(Chla_ugL_interp) ~ #Chla_t
              log10(Chla_ugL_interp_k7) + #Chla_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2018)) #subset data by year
aov(YRregk_Chla_2018)#prints the sum of squares for the regression and residuals
...
```{r}
YRregk_CD_2012<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2012) #subset data by year
...
YRregk_CD_2013<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2013) #subset data by year
...
YRregk_CD_2014<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2014) #subset data by year
...
YRregk_CD_2015<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2015) #subset data by year
...
YRregk_CD_2016<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2016) #subset data by year
...
YRregk_CD_2017<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2017) #subset data by year
...
YRregk_CD_2018<- glm(formula=log10(CD_cellsmL_interp) ~ #CD_t
              log10(CD_cellsmL_interp_k7) + #CD_t-k
                log10(ExtP_kgday_interp_k28) + #P_ext,t-k
                IntP_kgday_interp_k28, #P_int,t-k
              data=subset(Me_all_interp, Yr==2018) #subset data by year
