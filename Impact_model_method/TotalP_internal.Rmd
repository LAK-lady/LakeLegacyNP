...
write.csv(IntP_long, file="Products/Figure7_data.csv") #save data as table
fig7<- ggplot(subset(IntP_long), aes(x=Yr, y=TotP_kgday, 
...
ggsave(fig7, file="Products/Figure7.png")
```
