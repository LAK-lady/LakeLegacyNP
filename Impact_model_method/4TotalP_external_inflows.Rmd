...
SIfig6<-ggarrange(A,B,C, ncol=3, nrow=1) #prints plots together
SIfig6 #Prints the figure
ggsave(SIfig6, file="Products/SI_figures/Figure6_color.png") #save figure
...
### use rLOADEST package to print diagnostic plots ###
png(filename="Products/SI_figures/Figure9.png", width=900, height= 600)
layout(matrix(c(1,2,3,4,5,6), nrow=2, ncol=3))
...
SI_fig10 #prints out plot
ggsave(SI_fig10, file="Products/SI_figures/Figure10.png")
```
