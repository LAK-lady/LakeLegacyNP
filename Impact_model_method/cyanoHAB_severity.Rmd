...
b) defining and filtering data for cyanobacteria relative biovolume (CRB) and cyanobacteria density (CD)...
...
```{r}
a<- ggplot(data=Me_cyanoRB, aes(x=sampledate, y=cyano_relbiovol))+
