...
df<- merge(Epi_P, streams, by="sampledate")

ggplot(df, aes(x=sampledate)) +
  geom_point(epiP, aes( y=Epi_TotP_mgL))+
  geom_line(streams, aes(y=Flux))
...
```{r}
epiP<- ggplot(data=subset(Me_P_water, Yr>=2012), 
