...
extP_load<- merge(atm2, streams2, by=c("Yr", "daynum", "sampledate")) #adds two data files together
```
...
SI_fig12a<- ggplot(data=precip, aes(x=as.character(Yr), y=Precip_inyr)) + 
  geom_bar(stat="identity", color="black", fill="grey")+ 
  theme_classic()+
  labs(x=NULL, y="Precipitation (in)")
SI_fig12a

SI_fig12b<- ggplot(extP_load_source_sum, aes(x=as.character(Yr), y=TotP_kgyr, 
  ...
  labs(x="Year", y="External total P load (kg/yr)")
SI_fig12b #print plot
SI_fig12<- ggarrange(SI_fig12a, SI_fig12b, ncol=1, nrow=2, heights=c(0.5, 1))
SI_fig12
